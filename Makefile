...
install-crds:
	...
	kubectl apply -f https://raw.githubusercontent.com/stolostron/governance-policy-propagator/release-2.3/deploy/crds/policy.open-cluster-management.io_policies_crd.yaml
